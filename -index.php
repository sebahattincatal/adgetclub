...
<div <?=$div_statu?> class="modal fade bs-example-modal-lgs kargoara" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 ...
 <div class="input-group" style="width:250px;">
                <input type="text"  value="<?=date("d/m/Y")?>" class="form-control date" name="tarih" placeholder="<?=date("d/m/Y")?>" id="tarihs">
...
<div <?=$div_statu?> class="modal fade   dataView" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
...
<hr>
    ...
    <td width="237"><input type="submit" class="btn btn-primary" name="aktar" id="aktar" value="Dışarıya Aktar" /></td>
  </tr>
</table>
</form>
...
<div class="modal fade   musteriekle" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <button aria-hidden="true" data-dismiss="modal" class="close" type="button">&times;</button>
...
var tarih = $("#tarihs").val();
  if(tarih==""){
    ...
    var tss = '<iframe frameborder="0" width="5" height="5" src="http://gointeraktif.com/panel/inc/pages/this_excel.php?tarih='+tarih+'"></iframe>';
 $("#pops").html(tss);
  }
