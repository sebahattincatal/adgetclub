        ...
        <ul class="headermenu">
          <li>
            ...
            if($user_type<1){
             ...
             $esqlxxtt = $db->get_row("SELECT sum(fiyat) as ciro, count(*) as adet from  siparisler where  islem_tarihi between '".date("Y-m-d")." 00:00:00' AND '".date("Y-m-d")." 23:59:59'  AND  siparis_durumu in (7,8) AND  personel='".$_SESSION["admin_id"]."'  ");


echo $esqlxxtt->adet." Adet ".number_format($esqlxxtt->ciro,2)." ₺";
            }
          ...
          <li>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href="exit.php"><i class="glyphicon glyphicon-log-out"></i> Çıkış Yap</a></li>
              </ul>
            </div>
          </li>
          <li>
