            ...
            if ($_SESSION["user_type"] == 1) {
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Ürünler</span></a>
                    <ul class="children">
                        ...
                        <li><a href="pages.php?ido=urun_ekle"><span class="pull-right badge badge-danger">Yeni</span><i
                                    class="fa fa-caret-right"></i> Ürün Ekle</a></li>
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-user"></i> <span>Personel</span></a>
                    <ul class="children">
                        ...
                        <li><a href="pages.php?ido=personel_ekle"><span class="pull-right badge badge-danger">Yeni</span><i
                                    class="fa fa-caret-right"></i> Personel Ekle</a></li>
