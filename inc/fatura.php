                ...
                <div class="fatura_icerik">
                    <table width="270" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr height="20">
                            ...
                            <td width="40" align="center"><?= ($FetchOrder->fiyat - ($FetchOrder->fiyat * 0.08));?></td>
                    ...
                    <div style="float:left; width:140px;">
                        <table width="140" border="0" style="font-size:9px;">
                            ...
                            <tr>
                                ...
                                <td width="50"><?= ($FetchOrder->fiyat - ($FetchOrder->fiyat * 0.08));?> TL</td>
                            </tr>

                            <tr>
                                <td>Toplam KDV</td>
                                <td><?= ($FetchOrder->fiyat * 0.08);?> TL</td>
                            </tr>
