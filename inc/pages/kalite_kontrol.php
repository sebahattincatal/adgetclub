            ...
            <form class="form-horizontal form-bordered" id="KalGKontrol" method="post">
                <div id="f1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1">
                            <input type="text" placeholder="Tutar Giriniz" name="indirim" id="indirim" value="0"
                                   class="form-control"/>

                        </div>
                        <div class="col-sm-2">
                            <select class="form-control " name="indirim_tipi" id="indirim_tipi" style="width:400px"
                                    onchange="fiyatla();">
                                <?php
                                echo '
        ...
        <div class="panel-footer">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    ...
                    <button class="btn btn-info btn-lg" onclick="BilDuzenle('<?= $id ?>','mmds');" type="button">
                        Bilgileri Değiştir
                    </button>


                    <button class="btn btn-success btn-lg" onclick="KalOnay('<?= $id ?>','308');" type="button">Sonra
                        Ara
                    </button>
                    <button class="btn btn-success btn-lg" onclick="KalOnay('<?= $id ?>','Onay');" type="button">
                        Onayla
                    </button>
...
<div class="modal fade bs-example-modal-lg Khtsysa" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
...
<div class="modal fade bs-example-modal-lg Mdst" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                                                  data-toggle="tab">Kargo</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Agent</a>
                        </li>
                        <li role="presentation"><a href="#messages" aria-controls="messages" role="tab"
                                                   data-toggle="tab">Depo</a></li>
                        <li role="presentation"><a href="#settings" aria-controls="settings" role="tab"
                                                   data-toggle="tab">Müşteri</a></li>
                    </ul>
